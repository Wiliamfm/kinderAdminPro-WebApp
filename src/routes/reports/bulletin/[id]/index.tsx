...
import { getBulletin, updateBulletin } from '~/services/report.service';
...
export const usePostBolletin = routeAction$(async (req, event) => {
  const id = Number(event.params["id"]);
...
export default component$(() => {
  ...
  const updatebulletinAction = usePostBolletin();
