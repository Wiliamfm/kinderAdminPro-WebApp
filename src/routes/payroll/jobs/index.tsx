...
export const useCreateEmployeeJob = routeAction$(
  async (data, event) => {
    const response = await createEmployeeJob({
      name: data.name,
      salary: data.salary,
      ...
      actions: [
        ...
        <button
          ...
          onClick$={async () => {
            ...
            alert(
              `Trabajo ${deletedEmployeeJob.data.name} eliminado correctamente`,
            );
  ...
  return (
    <div class="flex h-full flex-col place-items-center space-y-10">
      ...
      <FormModal
        ...
        formAction={createEmployeeJobAction}
