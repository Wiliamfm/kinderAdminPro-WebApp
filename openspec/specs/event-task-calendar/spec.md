## Purpose
Define the admin event and task calendar capability, including calendar access, unified event/task records, multi-employee task assignments, edit affordances, compact rendering, and supported scheduling views.
